...
function() {
    ...
    angular.module("chaffers").directive("characterLinkFromData", [ "$injector", characterLinkFromData ]);
}(), function() {
    ...
    angular.module("chaffers").directive("characterSheetFromData", [ "$injector", characterSheetFromData ]);
}(), function() {
    ...
    function AbilityModifierFactory(BaseModel, extend) {
        function AbilityModifier() {
            this.displayName = void 0, this.modifier = void 0, BaseModel.apply(this, arguments);
        }
        ...
        AbilityModifier.prototype.getDisplayName = getDisplayName, AbilityModifier;
    }
    angular.module("chaffers").factory("AbilityModifier", [ "BaseModel", "extend", AbilityModifierFactory ]);
}(), function() {
    function AttributeModifierFactory(BaseModel, extend) {
        function AttributeModifier() {
            this.displayName = void 0, this.modifier = void 0, BaseModel.apply(this, arguments);
        }
        function getModifier() {
        ...
        return extend(AttributeModifier, BaseModel), AttributeModifier.prototype.getModifier = getModifier, 
        AttributeModifier.prototype.getDisplayName = getDisplayName, AttributeModifier;
    }
    angular.module("chaffers").factory("AttributeModifier", [ "BaseModel", "extend", AttributeModifierFactory ]);
}(), function() {
    function CharacterFactory(Specialty, Flaw, BaseModel, relationManager, extend, TextBlock) {
        function Character() {
            this.id = void 0, this.specialties = void 0, this.flaws = void 0, this.description = void 0, 
            this.displayName = void 0, BaseModel.apply(this, arguments);
        }
        function getDisplayName() {
            return this.displayName;
        }
        ...
        return extend(Character, BaseModel), Character.prototype.getDisplayName = getDisplayName, 
        ...
        relationManager.registerHasManyRelation(Character, "flaws", Flaw), relationManager.registerHasManyRelation(Character, "specialties", Specialty), 
        relationManager.registerHasOneRelation(Character, "description", TextBlock), Character;
    }
    angular.module("chaffers").factory("Character", [ "Specialty", "Flaw", "BaseModel", "relationManager", "extend", "TextBlock", CharacterFactory ]);
}(), function() {
    function characterTraitFactory(BaseModel, extend, relationManager, TextBlock, AttributeModifier, AbilityModifier) {
        function CharacterTrait() {
            this.displayName = void 0, this.description = void 0, this.attributeModifiers = void 0, 
            this.abilityModifiers = void 0, BaseModel.apply(this, arguments);
        }
        function getDisplayName() {
            return this.displayName;
        }
        ...
        return extend(CharacterTrait, BaseModel), relationManager.registerHasOneRelation(CharacterTrait, "description", TextBlock), 
    ...
    angular.module("chaffers").factory("CharacterTrait", [ "BaseModel", "extend", "relationManager", "TextBlock", "AttributeModifier", "AbilityModifier", characterTraitFactory ]);
}(), function() {
    ...
    function TextBlockFactory(BaseModel, extend) {
        function TextBlock() {
            this.formattedText = void 0;
        }
        function getText() {
            return this.formattedText;
        }
        return extend(TextBlock, BaseModel), TextBlock.prototype.getText = getText, TextBlock;
    }
    angular.module("chaffers").factory("TextBlock", [ "BaseModel", "extend", TextBlockFactory ]);
}(), function() {
    ...
    angular.module("djangular").factory("csrfService", [ "$cookies", csrfService ]);
}(), function() {
    ...
    angular.module("djangular").factory("djangoHTTP", [ "csrfService", "$http", "$injector", djangoHTTPFactory ]);
}(), function() {
