...
function() {
    ...
    angular.module("chaffers").directive("specialty", specialty), console.log("dog");
}(), function() {
    ...
    function extendFactory() {
        function extend(ChildClass, ParentClass) {
            ChildClass.prototype = Object.create(ParentClass), ChildClass.prototype.constructor = ChildClass;
        }
        return extend;
    }
    ...
    function populateInstanceFactory(relationManager, caseTransform) {
        function populateInstance(instanceToPopulate, dataForPopulation) {
            if (console.log(instanceToPopulate, dataForPopulation), "object" != typeof dataForPopulation) throw new Error("Data for population must be an object");
            ...
            dataKeys.forEach(function(dataKey) {
                ...
                console.log(camelCasedKey), (instanceToPopulate.constructor.prototype.hasOwnProperty(camelCasedKey) || instanceToPopulate.hasOwnProperty(camelCasedKey)) && (relationManager.isHasOneRelation(instanceToPopulate, camelCasedKey) ? populateHasOneRelation(instanceToPopulate, camelCasedKey, data) : relationManager.isHasManyRelation(instanceToPopulate, camelCasedKey) ? populateHasManyRelation(instanceToPopulate, camelCasedKey, data) : instanceToPopulate[camelCasedKey] = data);
            });
        }
    ...
    function CharacterFactory(Specialty, Flaw, BaseModel, relationManager, extend) {
        function Character() {
        ...
        return extend(Character, BaseModel), Character.prototype.specialties = void 0, Character.prototype.flaws = void 0, 
    ...
    angular.module("chaffers").factory("Character", [ "Specialty", "Flaw", "BaseModel", "relationManager", "extend", CharacterFactory ]);
}(), function() {
    function characterTraitFactory(BaseModel, extend) {
        ...
        return extend(CharacterTrait, BaseModel), CharacterTrait.prototype.displayName = void 0, 
        CharacterTrait.prototype.description = void 0, CharacterTrait.prototype.attributeModifiers = void 0, 
        CharacterTrait.prototype.abilityModifiers = void 0, CharacterTrait.prototype.getNameForDisplay = getNameForDisplay, 
        CharacterTrait.prototype.getDescription = getDescription, CharacterTrait.prototype.getAbilityModifiers = getAbilityModifiers, 
        CharacterTrait.prototype.getAttributeModifiers = getAttributeModifiers, CharacterTrait;
    }
    angular.module("chaffers").factory("CharacterTrait", [ "BaseModel", "extend", characterTraitFactory ]);
}(), function() {
