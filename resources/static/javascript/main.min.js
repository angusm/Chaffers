...
function() {
    ...
    function characterSheetFromData($injector) {
        function controller($scope, createPopulatedInstance, Character) {
            window.$scope = $scope, $scope.character = createPopulatedInstance(Character, $scope.characterData);
        }
        var directive = {
            scope: {
                characterData: "="
    ...
    function populateInstanceFactory(relationManager, caseTransform) {
        ...
        function getRelationInstance(instanceToPopulate, propertyString, data) {
            ...
            return console.log(relationInstance, data, RelationClass), populateInstance(relationInstance, data), 
            relationInstance;
        }
    ...
    function AttributeModifierFactory(BaseModel, extend) {
        function AttributeModifier() {
            this.modifier = void 0, BaseModel.apply(this, attributes);
        }
    ...
    function CharacterFactory(Specialty, Flaw, BaseModel, relationManager, extend, TextBlock) {
        function Character() {
            this.specialties = void 0, this.flaws = void 0, this.description = void 0, this.displayName = void 0, 
        ...
        Character.prototype.getDescription = getDescription, relationManager.registerHasManyRelation(Character, "flaws", Flaw), 
    ...
    function characterTraitFactory(BaseModel, extend, relationManager, TextBlock) {
        function CharacterTrait() {
    ...
    angular.module("chaffers").factory("CharacterTrait", [ "BaseModel", "extend", "relationManager", "TextBlock", characterTraitFactory ]);
}(), function() {
