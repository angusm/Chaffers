...
function() {
    ...
    function CharacterFactory(Specialty, Flaw, BaseModel, relationManager, extend, TextBlock) {
        ...
        return extend(Character, BaseModel), Character.prototype.getFlaws = getFlaws, Character.prototype.getSpecialties = getSpecialties, 
    ...
    function characterTraitFactory(BaseModel, extend, relationManager, TextBlock, AttributeModifier) {
        function CharacterTrait() {
        ...
        CharacterTrait.prototype.getNameForDisplay = getNameForDisplay, CharacterTrait.prototype.getDescription = getDescription, 
    ...
    angular.module("chaffers").factory("CharacterTrait", [ "BaseModel", "extend", "relationManager", "TextBlock", "AttributeModifier", characterTraitFactory ]);
}(), function() {
