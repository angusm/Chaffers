...
import isArray from '../handies/functions/is_array';
import isNonNullObject from '../handies/functions/is_non_null_object';
 ...
 */
export default function populateInstance(instance, data) {
    ...
    if (!isNonNullObject(data)) {
        throw new Error('Data for population must be a non-null object');
    }
